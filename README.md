...
It helps me setting up my picture profiles (SDR, HDR10, HDR+ and DOVI) after each firware update. It uses dummy certificate and private key to foolish the broker authentication, some TV models require permission via OTP.

It was tested on Android, iOS, Linux, macOS and Windows.
